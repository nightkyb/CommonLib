...
public class AgreeView extends View implements View.OnClickListener {
    ...
    //未点赞图片
    private Drawable agreeOffDrawable;
    ...
    private void initView(AttributeSet attrs) {
        if (attrs != null) {
            ...
            agreeDrawable = typedArray.getDrawable(R.styleable.AgreeView_img_on);
            agreeOffDrawable = typedArray.getDrawable(R.styleable.AgreeView_img_off);
    ...
    public void onClick(View v) {
        ...
        if (onAgreeListener != null) {
            onAgreeListener.onAgree(v, isAgree);
        }
    }
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        agreeOffDrawable.setBounds(rect);
    }

    public interface OnAgreeListener {
        void onAgree(View view, boolean isAgree);
    }
}
